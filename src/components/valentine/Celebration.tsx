...
const Celebration = ({ onSelectQuestionCount }: CelebrationProps) => {
  ...
  return (
    <div className="h-screen w-screen fixed inset-0 flex flex-col items-center justify-center bg-gradient-to-b from-background to-secondary p-4 relative overflow-hidden">
      ...
      <div className="flex flex-col items-center gap-8 max-w-2xl text-center z-10 bg-primary/20 backdrop-blur-sm rounded-2xl p-8 border border-primary/30 shadow-[0_0_30px_rgba(59,130,246,0.3)]">
